...
const SpeedMeasurePlugin = require('speed-measure-webpack-plugin')//打包的时间分析.
const BundleAnalyzerPlugin = require('webpack-bundle-analyzer').BundleAnalyzerPlugin;//打包后对文件进行分析.
    ...
    return {
        ...
        optimization: {
            ...
            splitChunks: {
                ...
                minChunks: 1,
                cacheGroups: {
                    vendor: {//第三方供应商node_modules打包时抽成这个命名
                        test: /[\\/]node_modules[\\/]/,
                        filename: "[id]_[hash:8]_vendors.js",
                        priority: -10,
                    },
                    default: {
                        minChunks: 2,
                        filename: "common_[id]_[hash:8].js",
                        priority: -20
                    }
                }
            }
        ...
        module: {
            rules: [
                ...
                },
                {
                    ...
                    // ]
                    type: "asset",
                    generator: {//自定义文件输出路径和属性
                        filename: "img/[name].[hash:6][ext]"
                    },
                    parser: {// url-loader 的limit 效果
                        dataUrlCondition: {
                            maxSize: 100 * 1024
                        }
                    }
